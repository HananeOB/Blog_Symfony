 ...
 */
final class Version20200512084234 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE articles ADD user_id INT NOT NULL, CHANGE date_maj date_maj DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE articles DROP user_id, CHANGE date_maj date_maj DATETIME DEFAULT \'NULL\'');
